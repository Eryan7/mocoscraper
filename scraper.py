...
tab2 = WebDriverWait(driver, 60).until(lambda x: x.find_element(By.XPATH, "//a[@href='#tab-4876-2']"))
tab2.click()
download2 = WebDriverWait(driver, 60).until(lambda x: x.find_element(By.ID, 'downloadData2'))
download2.click()

tab3 = WebDriverWait(driver, 60).until(lambda x: x.find_element(By.XPATH, "//a[@href='#tab-4876-3']"))
tab3.click()
