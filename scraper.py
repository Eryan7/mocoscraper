...
tab2 = WebDriverWait(driver, 60).until(lambda x: x.find_element(By.XPATH, "//a[@id='ui-tab-526']"))
tab2.click()
download2 = WebDriverWait(driver, 60).until(lambda x: x.find_element(By.ID, 'downloadData2'))
download2.click()

tab3 = WebDriverWait(driver, 60).until(lambda x: x.find_element(By.XPATH, "//a[@id='ui-tab-570']"))
tab3.click()
